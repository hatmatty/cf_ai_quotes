document.addEventListener("DOMContentLoaded", async () => {
  ...
  try {
    ...
    // Show loading indicator for similar quotes
    similarQuotesContainer.innerHTML = '<p class="loading-indicator">Finding similar quotes</p>';
    ...
    if (results.length === 0) {
      similarQuotesContainer.innerHTML = '<p style="text-align: center; color: #666; padding: 2rem;">Found no similar quotes</p>';
    } else {
      // Clear loading indicator
      similarQuotesContainer.innerHTML = '';
